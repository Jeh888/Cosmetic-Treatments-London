...
export const faqs = {
  general: [
    ...
    },
    {
      ...
      answer: 'Yes, our comparison service is completely free for patients. There\'s no obligation to book with any of the providers who contact you, and you won\'t be charged for receiving quotes.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Most patients receive their first quote within 24 hours of submitting their request. You\'ll typically hear from all matched providers within 48 hours.'
    },
    {
      question: 'Can I choose which providers contact me?',
      answer: 'We match you with providers based on your location, required treatment, and preferences. You can specify any requirements in your quote request, and you\'re never obligated to proceed with any quote you receive.'
    },
    {
      question: 'What areas do you cover?',
      answer: 'We cover all London boroughs and surrounding areas, with over 100 locations across the capital. Whether you\'re in Central, North, South, East, or West London, we can connect you with local providers.'
    }
  ],
  treatments: {
    'botox': [
      ...
      },
      {
        ...
        answer: 'When administered by a skilled practitioner, Botox should look natural. Modern techniques focus on softening wrinkles while maintaining natural facial expressions.'
      },
      {
        question: 'Is Botox safe?',
        answer: 'Botox has been used safely for cosmetic purposes for over 20 years. Side effects are typically mild and temporary, such as slight bruising at injection sites.'
      },
      {
        question: 'At what age should I start Botox?',
        answer: 'There\'s no set age to start Botox. Some people begin in their late 20s as a preventative measure, while others start later to treat existing wrinkles. It depends on your individual concerns.'
      },
      {
...
export function getFaqsByTreatment(treatmentSlug) {
  return faqs.treatments[treatmentSlug] || [];
}
